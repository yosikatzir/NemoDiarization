...
REM Corporate network version with --trusted-host support
...
echo Corporate Network Version
echo ========================================
echo.
...
pip install -r requirements_minimal_diarization_only.txt --trusted-host nexuspro --trusted-host pypi.org --trusted-host files.pythonhosted.org
...
echo - Corporate network: --trusted-host nexuspro
echo.
echo Next steps:
